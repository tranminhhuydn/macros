...
describe('Macros', () => {
  ...
  describe('when the macros:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let macrosElement = workspaceElement.querySelector('.macros');
        expect(macrosElement).toExist();

        let macrosPanel = atom.workspace.panelForItem(macrosElement);
